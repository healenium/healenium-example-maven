...
//    }
    ...
    public void testFindElementByLinkText() {
        ...
        page.openPage()
                .findTestElement(LocatorType.LINK_TEXT, "HealedLinkText")
                .clickSubmitButton()
                .findTestElement(LocatorType.LINK_TEXT, "HealedLinkText");
    }
    ...
    public void testFindElementByName() {
        ...
        page.openPage()
                .findTestElement(LocatorType.NAME, "healed_change_name")
                .clickSubmitButton()
                .findTestElement(LocatorType.NAME, "healed_change_name");
    }
    ...
    public void testFindElementByTagName() {
        ...
        page.openPage();
        driver.findElement(By.tagName("healed_test_tag")).isDisplayed();
