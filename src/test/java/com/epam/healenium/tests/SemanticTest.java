...
//    }
    ...
    public void testFindElementByLinkText() {
        ...
        page.openPage()
                .findTestElement(LocatorType.LINK_TEXT, "UpdatedLinkText")
                .clickSubmitButton()
                .findTestElement(LocatorType.LINK_TEXT, "UpdatedLinkText");
    }
    ...
    public void testFindElementByName() {
        ...
        page.openPage()
                .findTestElement(LocatorType.NAME, "updated_change_name")
                .clickSubmitButton()
                .findTestElement(LocatorType.NAME, "updated_change_name");
    }
    ...
    public void testFindElementByPartialLinkText() {
        ...
        page.openPage()
                .findTestElement(LocatorType.PARTIAL_LINK_TEXT, "UpdatedPartialLinkText")
                .clickSubmitButton()
                .findTestElement(LocatorType.PARTIAL_LINK_TEXT, "UpdatedPartialLinkText");
    }
    ...
    public void testFindElementByTagName() {
        ...
        page.openPage();
        driver.findElement(By.tagName("updated_test_tag")).isDisplayed();
